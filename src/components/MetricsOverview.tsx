      ...
      <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-y md:divide-y-0 divide-zinc-800/60">
        ...
        <div className="p-3.5 sm:p-4 bg-[#080B10]/90 flex flex-col justify-between group hover:bg-[#0A0E15] transition-colors relative">
          ...
          <div className="my-2">
            <div className="flex items-baseline gap-1.5">
              ...
              <span className="text-[10px] font-oxanium text-emerald-400 font-bold">TOKENS</span>
            </div>
            <div className="text-[10px] font-mono text-zinc-400 mt-0.5">
        ...
        <div className="p-3.5 sm:p-4 bg-[#080B10]/90 flex flex-col justify-between group hover:bg-[#0A0E15] transition-colors relative">
          ...
          <div className="my-2">
            <div className="flex items-baseline gap-1.5">
              ...
              <span className="text-[10px] font-oxanium text-rose-400 font-bold">TOKENS</span>
            </div>
        ...
        <div className="p-3.5 sm:p-4 bg-[#080B10]/90 flex flex-col justify-between group hover:bg-[#0A0E15] transition-colors relative">
          ...
          <div className="my-2">
            ...
            <div className="text-[10px] font-mono text-zinc-400 mt-0.5">
              ${state.tokenPriceUSD.toFixed(6)} / TOKEN
            </div>
          </div>
